 ...
 * @version 1.0
 */
public class CleanFreeTTSWordToSoundTest extends TestCase {
     ...
     */
    public CleanFreeTTSWordToSoundTest(String name) {
        super(name);
    }

    public void setUp() {
        this.cleanFreeTTSwordToSound = new CleanFreeTTSWordToSound(new FreeTTSSoundConfigurator(voiceName, voicePackage, 1.0f, 100, 100), 3, 6);
