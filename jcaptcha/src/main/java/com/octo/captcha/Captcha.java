 ...
 * image captchas or wathever)</li> <li>a validation routine a of a given response</li> </ul>
 * <p>
 * This is a container for the CAPTCHA challenge which is also able to validate the answer. Class implementing this
 * interface must follow the rules : </p><ul> <li>As all 'components' of this project, all contructed objects should be
